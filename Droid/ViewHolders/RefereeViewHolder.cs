...
{
    public class RefereeViewHolder<T> : RecyclerView.ViewHolder
    {
        public ImageView Image { get; set; }

        public TextView Text { get; set; }

        public RefereeViewHolder(View itemView, Action<object> listener, BaseRecyclerViewAdapter<T> adapter) : base(itemView)
        {
