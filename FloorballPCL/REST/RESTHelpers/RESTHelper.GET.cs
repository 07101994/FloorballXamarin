...
namespace Floorball.REST.RESTHelpers
{
    public partial class RESTHelper : RESTHelperBase
    {
        ...
        public async static Task<LeagueModel> GetLeagueByIdAsync(int leagueId)
		{
        ...
        public async static Task<PlayerModel> GetPlayerByIdAsync(int playerId)
		{
        ...
        public async static Task<EventMessageModel> GetEventMessageByIdAsync(int eventMessageId)
		{
